        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-2 col-6 order-lg-1 order-1">
                <div class="d-flex align-items-center">
                        ...
                        <div class="offcanvas offcanvas-start" tabindex="-1" id="responsiveMenu"
                            ...
                            <div class="offcanvas-body">
                                <a href="" class="text-center d-block mb-3">
                                    <img src="{{ asset('web/home/assets/image/logo.png')}}" alt="" class="img-fluid" width="200">
                                </a>
                    ...
                    <a href="index.html">
                        <div class="logo">
                            <img src="{{ asset('web/home/assets/image/logo.png') }}" alt="" class="img-fluid">
                        </div>
                    </a>
                </div>
            </div>
                ...
                <div class="d-flex align-items-center justify-content-end">
                    ...
                    <div class="dropdown ms-3">
                        <a href="#register" data-bs-toggle="dropdown" aria-expanded="false" role="button"
                            ...
                            <figure class="avatar">
                                <img src="{{ asset('web/home/assets/image/user.png')}}" alt="amirRezae">
                            </figure>
                        </a>
            ...
            <div class="col-lg-4 order-lg-3 d-lg-block d-none">
                <div class="d-flex align-items-center justify-content-end">
                    <div class="btn-group header-btn-group shadow-sm rounded-pill">
                        ...
                        <a href="{{ route('login') }}" class="btn btn-white header-login border-0 rounded-pill">ورود</a>
                    </div>
