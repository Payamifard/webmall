                    ...
                    <div class="top-menu-menu">
                        <ul class="navbar-nav align-items-center">
                                ...
                                <ul class="main-menu mega-container">
                                    <li class="main-menu-sub-active-li"><a href=""><i class="bi bi-phone"></i>
                                        ...
                                        <ul class="main-menu-sub back-menu"
                                            style=" background: #fff url('web/home/assets/image/509-5092096_offering-high-quality-mobile-repair-service-main-image_prev_ui.png') no-repeat;">
                                    ...
                                    <li><a href=""><i class="bi bi-tablet"></i> تبلت</a>
                                        <ul class="main-menu-sub back-menu"
                                            style=" background: #fff url('web/home/assets/image/tablet-menu.png') no-repeat;">
                                            ...
                                            <li><a class="title my-flex-baseline" href="">تبلت بر اساس قیمت</a></li>
                                    ...
                                    <li><a href=""><i class="bi bi-shield"></i>آنتی ویروس</a>
                                        <ul class="main-menu-sub back-menu"
                                            style=" background: #fff url('web/home/assets/image/EAV.png') no-repeat;">
                                    ...
                                    <li><a href=""><i class="bi bi-laptop"></i>لبتاپ</a>
                                        <ul class="main-menu-sub back-menu"
                                            style=" background: #fff url('web/home/assets/image/labtop.png') no-repeat;">
                                            <li><a class="title my-flex-baseline" href="">برند های مختلف لبتاپ</a>
                                            </li>
                                    ...
                                    <li><a href=""><i class="bi bi-tag"></i>پر فروش ترین ها</a>
                                        <ul class="main-menu-sub back-menu"
                                            style=" background: #fff url('web/home/assets/image/top-sales.jpeg') no-repeat;">
                            ...
                            <!-- end mega menu -->
                             ...
                             <!-- start mega menu -->
                            {{-- <li class="nav-item"><a href="" class="nav-link border-animate fromCenter">مگا لیست منو
                                    <i class="bi bi-tablet"></i></a>
                                <ul class="list-unstyled shadow-lg back-menu sub-menu mega-container"
                                    style="background: #fff url('web/home/assets/image/mega-img-1.jpg') no-repeat;background-size: 400px !important;">
                            ...
                            <li class="nav-item"><a href="" class="nav-link border-animate fromCenter">دسته بندی محصولات<i
