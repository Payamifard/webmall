            ...
            <div class="row gy-3">
                <div class="col-lg-9">
                    <div class="footer-menu-text">
                        <img src="web/home/assets/image/logo.png" class="img-fluid" alt="">
                ...
                <div class="col-lg-3">
                    <div class="footer-namad">
                        <a href="">
                            <img src="{{ asset('web/home/assets/image/enamad.png') }}" alt="" class="img-thumbnail">
                        </a>
                        <a href="">
                            <img src="{{ asset('web/home/assets/image/rezi.png') }}" alt="" class="img-thumbnail">
                        </a>
                    </div>
                </div>
            </div>
